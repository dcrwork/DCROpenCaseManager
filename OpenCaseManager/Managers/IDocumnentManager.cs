...
namespace OpenCaseManager.Managers
{
    public interface IDocumnentManager
    {
        ...
        Tuple<string,string> AddDocument(string instanceId, string fileType, string givenFileName, string fileName, string eventId, DateTime eventDateTime, bool isLocked, IManager manager, IDataModelManager dataModelManager);
    }
}
