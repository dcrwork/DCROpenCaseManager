...
$(document).ready(function () {
    getDataForAllMyChildren();
});
 

function getDataForAllMyChildren() {
...
function getChildInstanceHtml(item) {
    ...
    var objTest = new Date("2019-04-17 09:43:24.5334795");
    ...
    returnHtml += (item.NextDeadline != null) ? "<td >" + date + " " + time + "</td>" : "<td>ngen kommende deadlines</td>";
