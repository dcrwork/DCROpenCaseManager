...
(function (window) {
    ...
    function getTasks(entityName, onlyMyTasks, onlyOpenInstance, instanceId, resolve, reject) {
        ...
        var query = {
            "type": "SELECT",
            "entity": entityName,
            "resultSet": ["EventId", "TrueEventId", "Responsible", "InstanceId", "EventTitle", "Due", "SimulationId", "GraphId", "IsPending", "IsExecuted", "CanExecute", "ResponsibleName", "Description", "IsUIEvent", "UIEventValue", "EventType", "[Type]", "[Case]", "CaseLink", "CaseTitle", "MyTask"],
            "filters": new Array(),
