    ...
    public static class Common
    {
        ...
        public static string AddInstance(AddInstanceModel model, IManager manager, IDataModelManager dataModelManager)
        {
            ...
            try
            {
                ...
                dataModelManager.AddParameter(DBEntityNames.Instance.Responsible.ToString(), Enums.ParameterType._int, model.Responsible.ToString());
        ...
        public static string AddDocument(string documentName, string type, string link, string instanceId, string childId, bool isDraft, DateTime eventDateTime, IManager manager, IDataModelManager dataModelManager)
        {
            try
            {
                ...
                AddJournalHistory(instanceId, null, documentId, type, documentName, eventDateTime, manager, dataModelManager, childId);
                return documentId;
            }
            catch (Exception ex)
            {
        ...
        public static void AddJournalHistory(string instanceId, string eventId, string documentId, string type, string title, DateTime eventDateTime, IManager manager, IDataModelManager dataModelManager, string childId = "")
        {
            if (!string.IsNullOrEmpty(instanceId))
            {
                ...
                if (!String.IsNullOrEmpty(childId)) dataModelManager.AddParameter(DBEntityNames.JournalHistory.ChildId.ToString(), Enums.ParameterType._int, childId.ToString());
