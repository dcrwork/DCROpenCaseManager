...
namespace OpenCaseManagerTests
{
    public class CommonTests
    {
        ...
        public void AddJournalHistory_correct_input_verify_DataManager_is_called()
        {
            ...
            Common.AddJournalHistory("1", "1", null, "Event", "Slicing pizzas", DateTime.Now, true, manager.Object, dataManager.Object);
        ...
        public void AddJournalHistory_given_null_EventId_does_not_add_it_as_parameter()
        {
            ...
            Common.AddJournalHistory("1", null, "42", "Event", "Slicing pizzas", DateTime.Now, true, manager.Object, dataManager.Object);
        ...
        public void AddJournalHistory_given_no_title_throws_an_exception()
        {
            ...
            Assert.Throws<NullReferenceException>(() => Common.AddJournalHistory(instanceId, null, "42", "Event", "Wuhu", DateTime.Now, true, manager.Object, dataManager.Object));
        }
    }
}